...
function ns.Debug:CreateWindow()
    ...
    placeButton(frame.mapscanStatusButton, frame.buttonRow, 216, -56)
    ...
    placeButton(frame.helpButton, frame.buttonRow, 334, -56)
...
function ns.Debug:RefreshWindow()
    ...
    self.window.sweepButton:SetEnabled(profile.debug)
    ...
    self.window.sweepButton:SetText(debugDB.sweepMode and Locale:Get("DEBUG_SWEEP_OFF") or Locale:Get("DEBUG_SWEEP_ON"))
end
