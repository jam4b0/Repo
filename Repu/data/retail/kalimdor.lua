    ...
    locations = {
        zones = {
            ...
            [62] = {
                ...
                source = "seed",
                confidence = "medium",
                notes = "Canonical Darkshore zone kept separate from world-state variant submaps.",
                mapIDs = { 62 },
            ...
            ["silithus: die wunde"] = {
                ...
                source = "seed",
                confidence = "medium",
                notes = "Retail phase variant of Silithus after the sword impact; faction mapping pending.",
                mapIDs = { 81 },
                zoneKeys = { "silithus die wunde" },
                tags = { "zone", "local", "kalimdor", "variant", "coverage-only" },
            },
            [83] = {
                name = "Winterquell",
                source = "seed",
        ...
        subZones = {
            ["1203:dunkelküste"] = {
                ...
                source = "seed",
                confidence = "medium",
                notes = "Darkshore world-state variant submap; kept separate until a correct phase-specific faction mapping is defined.",
                mapIDs = { 1203 },
                tags = { "subzone", "coverage-only", "kalimdor", "variant-separated", "world-phasing-variant" },
            },
            ["1332:dunkelküste"] = {
                name = "Dunkelküste",
                parentMapID = 62,
