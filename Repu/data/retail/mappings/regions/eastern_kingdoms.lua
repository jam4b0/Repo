    ...
    locations = {
        zones = {
            ...
            [2405] = {
                ...
                source = "observed",
                confidence = "medium",
                notes = "Observed localized Midnight zone for the void campaign branch.",
                mapIDs = { 2405 },
                tags = { "zone", "local" },
                factions = {
        ...
        subZones = {
            ...
            ["2413:harandar"] = {
                ...
                source = "seed",
                confidence = "medium",
                notes = "Localized Midnight subzone anchor for the Hara'ti branch.",
                mapIDs = { 2413 },
                tags = { "primary", "local" },
                factions = {
            ...
            ["2437:zul'aman"] = {
                ...
                source = "seed",
                confidence = "medium",
                notes = "Localized Midnight subzone anchor for the Amani branch.",
                mapIDs = { 2437 },
                tags = { "primary", "local" },
                factions = {
