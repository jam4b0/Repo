    ...
    locations = {
        zones = {
            ...
            [14] = {
                ...
                source = "seed",
                confidence = "medium",
                notes = "Canonical Arathi Highlands zone kept separate from world-state variants.",
                mapIDs = { 14 },
                zoneKeys = { "arathihochland" },
                tags = { "zone", "coverage-only", "eastern-kingdoms", "variant-separated" },
            },
            [2372] = {
                name = "Arathihochland",
                source = "seed",
                confidence = "medium",
                notes = "World-state variant of Arathi Highlands; kept separate until a correct phase-specific faction mapping is defined.",
                mapIDs = { 2372 },
                zoneKeys = { "das arathihochland" },
                tags = { "zone", "coverage-only", "eastern-kingdoms", "variant-separated", "world-phasing-variant" },
            },
            [2451] = {
                name = "Arathihochland",
                source = "seed",
                confidence = "medium",
                notes = "Additional world-state variant of Arathi Highlands; kept separate until a correct phase-specific faction mapping is defined.",
                mapIDs = { 2451 },
                zoneKeys = { "das arathihochland" },
                tags = { "zone", "coverage-only", "eastern-kingdoms", "variant-separated", "world-phasing-variant" },
            },
